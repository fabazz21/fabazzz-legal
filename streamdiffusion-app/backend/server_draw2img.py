"""
Flask server for real-time drawing-to-image generation
"""
import os
import io
import base64
...
def initialize_engine():
    ...
    print("Drawing-to-Image server initialized!")
...
def process_frame():
    ...
    global generator, current_prompt, latest_drawing
...
def update_prompt():
    ...
    global current_prompt, engine, latest_drawing, generator
    ...
    try:
        ...
        if new_prompt and new_prompt != current_prompt:
            ...
            # If we have a latest drawing, re-process it with new prompt
            if latest_drawing:
                generator.send_image(latest_drawing, current_prompt)
...
def save_drawing():
    ...
    global latest_drawing

    try:
        if latest_drawing is None:
            return jsonify({
                'status': 'error',
                'message': 'No drawing to save'
            }), 400
...
if __name__ == '__main__':
    print("Starting Drawing-to-Image StreamDiffusion Server...")
